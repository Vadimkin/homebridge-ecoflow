...
export declare enum DeltaProUltraMqttMessageAddrType {
...
export interface DeltaProUltraMqttQuotaMessageWithParams<TParams> extends MqttQuotaMessageWithParam<TParams>, DeltaProUltraMqttQuotaMessage {
}
export declare enum DeltaProUltraMqttSetCmdCodeType {
...
export interface DeltaProUltraMqttSetMessageWithParams<TParams extends DeltaProUltraMqttSetMessageParams> extends MqttSetMessageWithParams<TParams>, DeltaProUltraMqttSetMessage {
}

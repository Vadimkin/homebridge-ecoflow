...
export declare enum PowerStreamMqttMessageType {
    Heartbeat = 1,
    Task = 134
}
export declare enum PowerStreamMqttMessageFuncType {
    Func20 = 20
}
...
export interface PowerStreamMqttQuotaMessageWithParams<TParams> extends MqttQuotaMessageWithParam<TParams>, PowerStreamMqttQuotaMessage {
}
export declare enum PowerStreamMqttSetCmdCodeType {
...
export interface PowerStreamMqttSetMessageWithParams<TParams extends PowerStreamMqttSetMessageParams> extends MqttSetMessageWithParams<TParams>, PowerStreamMqttSetMessage {
}
